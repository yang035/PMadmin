...
function dTree(objName, objbool) {
    this.config = {
        target: null,
        folderLinks: false,
        useSelection: false,
    ...
    this.icon = {
        root: '/static/js/dtree/img/base.gif',
        folder: '/static/js/dtree/img/folder.gif',
        folderOpen: '/static/js/dtree/img/folderopen.gif',
        node: '/static/js/dtree/img/page.gif',
        empty: '/static/js/dtree/img/empty.gif',
        line: '/static/js/dtree/img/line.gif',
        join: '/static/js/dtree/img/join.gif',
        joinBottom: '/static/js/dtree/img/joinbottom.gif',
        plus: '/static/js/dtree/img/plus.gif',
        plusBottom: '/static/js/dtree/img/plusbottom.gif',
        minus: '/static/js/dtree/img/minus.gif',
        minusBottom: '/static/js/dtree/img/minusbottom.gif',
        nlPlus: '/static/js/dtree/img/nolines_plus.gif',
        nlMinus: '/static/js/dtree/img/nolines_minus.gif'
    };
    this.obj = objName;
    this.aNodes = [];
    this.aIndent = [];
    ...
    this.RadioRocheckbox = objbool | false;
...
dTree.prototype.node = function (node, nodeId) {
    ...
    if (node.url) {
        ...
        // str += '<a href="javascript: ' + this.obj + '.o(' + nodeId + ');" class="node">';//old
        str += '<a href="javascript: ' + this.obj + '.checkSNode(' + nodeId + ');" class="node dep">';//new
...
dTree.prototype.checkSNode = function (id) {
    $('#dd'+id+' input[type=checkbox]').click();
};
