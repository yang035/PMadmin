...
class ReportReply extends Admin
{
    ...
    public function add(){
        ...
        $flow_cat = Project::getOption1($row['subject_id']);
    ...
    public function flowCat(){
        ...
        $str = Project::getChilds($row['subject_id'],$params['flow_cat']);
        return $this->success("操作成功",'',$str);
    }

    public function flowCat20200628(){
        $params = $this->request->param();
