...
//            print_r($file_name);exit();
    ...
    public function addItem()
    {
        if ($this->request->isPost()) {
            ...
            if (isset($data['association_coefficient'])){
                $data['association_coefficient'] = implode(',',array_filter($data['association_coefficient']));
            }else{
                $data['association_coefficient'] = '';
            }
            unset($data['id']);
            // 验证
        ...
        $association_coefficient = config('other.association_coefficient');
        $this->assign('cat_option',ItemModel::getOption());
        $this->assign('association_coefficient',$association_coefficient);
