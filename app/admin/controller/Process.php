...
use app\admin\model\ProcessCat as CatModel;
use app\admin\model\ProcessItem as ItemModel;
...
class Process extends Admin
{
    ...
    public function addItem()
    {
        if ($this->request->isPost()) {
            ...
            unset($data['id']);
            // 验证
            $result = $this->validate($data, 'ProcessItem');
            if($result !== true) {
    ...
    public function addCat()
    {
        if ($this->request->isPost()) {
            ...
            unset($data['id']);
            // 验证
            $result = $this->validate($data, 'ProcessCat');
            if($result !== true) {
                return $this->error($result);
            }
