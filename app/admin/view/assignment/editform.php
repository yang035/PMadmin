...
<!--        </div>-->
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <button type="button" class="layui-btn layui-btn-normal" id="send_user_id">选择</button>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <button type="button" class="layui-btn layui-btn-normal" id="deal_user_id">选择</button>
