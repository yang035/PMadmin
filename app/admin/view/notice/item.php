...
<div class="page-toolbar">
    <div class="page-filter">
        ...
        <div class="layui-btn-group fl">
            ...
            <a data-href="{:url('status?table=notice_item&val=1')}" class="layui-btn layui-btn-primary j-page-btns layui-icon layui-icon-play" data-table="dataTable">&nbsp;启用</a>
            <a data-href="{:url('status?table=notice_item&val=0')}" class="layui-btn layui-btn-primary j-page-btns layui-icon layui-icon-pause" data-table="dataTable">&nbsp;禁用</a>
