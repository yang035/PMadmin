...
<form class="layui-form layui-form-pane" action="{:url()}" method="post" id="editForm">
    <div class="layui-form-item">
        ...
        <div class="layui-form-mid">总共<span id="max_score" style="color: red;">{$data_list['score']}</span>分</div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">评分情况</label>
        <div class="layui-form-mid">评定人有[<span class="red"><b>{$p[0]}</b></span>]个,你是第[<span class="red"><b>{$p[1]}</b></span>]评定人，请确认！</div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="number" class="layui-input field-add_score" name="add_score[]" onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))" autocomplete="off" placeholder="可得产值">
        </div>
        <div class="layui-input-inline">
