...
<div class="layui-form">
    <table class="layui-table mt10" lay-even="" lay-skin="row">
        ...
        <tr>
            ...
            <td class="font12">
                <a href="{:url('projectDetail',['uid'=>$vo['id'],'realname'=>$vo['realname'],'search_date'=>$d])}"><strong class="mcolor">{$vo['realname']}</strong></a>
            </td>
            <td class="font12">
                {empty name="vo['num']"}0
                {else/}
                <a href="{:url('projectDetail',['uid'=>$vo['id'],'realname'=>$vo['realname'],'search_date'=>$d])}"><strong class="mcolor">{$vo['num']}</strong></a>
                {/empty}
            </td>
        </tr>
        {/volist}
