...
<script>
    layui.use(['jquery', 'laydate','table'], function() {
        ...
        table.render({
            ...
            ,where: {
                ...
                subject_name: '{$Request.param.subject_name}',
            ...
            ,cols: [[ //表头
                ...
                {field: 'subject_name', title: '项目'},
                {field: 'last_total_fafang', title: '之前累计发放M'},
                {field: 'benci_fafang', title: '本次发放M'},
                {field: 'total_fafang', title: '累计发放M'},
    ...
    new SelectBox($('.box1'),{$project_select},function(result){
        ...
        defalut:'{$Request.param.subject_name}',//默认显示内容。如果是'firstData',则默认显示第一个
