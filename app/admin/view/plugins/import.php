<form class="layui-form layui-form-pane" action="{:url()}" id="editForm" method="post">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline upload">
            <button type="button" name="upload" class="layui-btn layui-btn-primary layui-upload" lay-data="{exts:'zip', accept:'file'}">请上传插件安装包</button>
...
layui.use(['jquery', 'laydate', 'upload'], function() {
    ...
    upload.render({
        elem: '.layui-upload',
        url: '{:url("admin/UploadFile/upload?thumb=no&water=no&group=temp")}'
        ,method: 'post'
