...
<head>
    ...
    <style type="text/css">
        ...
        .login-box input[name="re_password"]{letter-spacing:5px;font-weight:800}
    ...
    <div class="login-box">
        ...
        <form action="{:url()}" method="post" class="layui-form layui-form-pane">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="password" name="re_password" class="layui-input" lay-verify="required" placeholder="******" value="">
                </div>
            </div>
            ...
            <input type="submit" value="更改" lay-submit="" lay-filter="formLogin" class="layui-btn layui-btn-warm" style="background-color: #fe9900">
            <div>
...
<script type="text/javascript">
    ...
    function send_code() {
        var username=$('#username').val(),company_id=$('#company_id').val();
        $.ajax({
            type: 'POST',
            url: "{:url('sendCode')}",
