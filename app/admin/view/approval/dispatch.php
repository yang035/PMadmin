...
<!--    </div>-->
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">派遣事由</label>
        <div class="layui-input-inline">
            <textarea type="text" class="layui-textarea field-reason" name="reason" lay-verify="required" autocomplete="off" placeholder="请输入派遣事由"></textarea>
        </div>
        <div class="layui-form-mid" style="color: red">*</div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">派遣地点</label>
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-address" name="address" autocomplete="off" placeholder="请输入派遣地点">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">联系人</label>
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-contacts" name="contacts" autocomplete="off" placeholder="请输入联系人信息">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">随身物品</label>
        <div class="layui-input-inline">
            <textarea type="text" class="layui-textarea field-belongs" name="belongs" autocomplete="off" placeholder="请输入随身物品"></textarea>
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <button type="button" class="layui-btn layui-btn-normal" id="deal_user_id">选择执行人</button>
