...
<!--    </div>-->
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-name" lay-verify="required" name="name" autocomplete="off" placeholder="请输入名称">
        </div>
        <div class="layui-form-mid" style="color: red">*</div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-identity_number" lay-verify="required" name="identity_number" autocomplete="off" placeholder="请输入纳税人识别号">
        </div>
        <div class="layui-form-mid" style="color: red">*</div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-address" lay-verify="required" name="address" autocomplete="off" placeholder="请输入地址和电话">
        </div>
        <div class="layui-form-mid" style="color: red">*</div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="number" class="layui-input field-money" lay-verify="required" name="money" autocomplete="off" placeholder="请输入开票金额">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-contract_number" lay-verify="required" name="contract_number" autocomplete="off" placeholder="请输入合同号">
        </div>
        <div class="layui-form-mid" style="color: red">*</div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="number" class="layui-input field-total_money" lay-verify="required" name="total_money" autocomplete="off" placeholder="请输入总金额">
        </div>
        <div class="layui-form-mid">元</div>
        <div class="layui-form-mid" style="color: red">*</div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="number" class="layui-input field-has_money" lay-verify="required" name="has_money" autocomplete="off" placeholder="请输入已结算金额">
        </div>
        <div class="layui-form-mid">元</div>
        <div class="layui-form-mid" style="color: red">*</div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">发票备注栏信息</label>
        <div class="layui-input-inline">
            <textarea type="text" class="layui-textarea field-infomation" name="infomation" lay-verify="required" autocomplete="off" placeholder="项目名称+项目地址"></textarea>
        </div>
        <div class="layui-form-mid" style="color: red">*</div>
    </div>
    <div class="layui-form-item">
