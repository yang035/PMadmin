...
<!--    </div>-->
    ...
    <div class="layui-form-item hide">
        ...
        <div class="layui-input-inline">
            ...
            <input type="hidden" class="layui-input field-time_long1" name="time_long1" value="">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">事由</label>
        <div class="layui-input-inline">
            <textarea type="text" class="layui-textarea field-reason" name="reason" lay-verify="required" autocomplete="off" placeholder="请输入事由"></textarea>
        </div>
        <div class="layui-form-mid" style="color: red">*</div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-start_address" lay-verify="required" name="start_address" autocomplete="off" placeholder="请输入起点">
        </div>
        <div class="layui-form-mid" style="color: red">*</div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-end_address" lay-verify="required" name="end_address" autocomplete="off" placeholder="请输入终点">
        </div>
        <div class="layui-form-mid" style="color: red">*</div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-mileage" lay-verify="required" name="mileage" autocomplete="off" placeholder="请输入行驶里程">
        </div>
        <div class="layui-form-mid" style="color: red">公里*</div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">车辆类型</label>
        <div class="layui-input-inline">
            <select name="car_type" class="field-type" type="select">
                {$car_type}
            </select>
        </div>
    </div>
...
<!--        <div class="layui-input-inline">-->
<!--            <button type="button" class="layui-btn layui-btn-normal" id="deal_user_id">选择司机</button>-->
<!--            <div id="deal_select_id"></div>-->
<!--            <input type="hidden" name="deal_user" id="deal_user" value="" lay-verify="required">-->
<!--        </div>-->
<!--        <div class="layui-form-mid" style="color: red">*</div>-->
<!--    </div>-->
<!--    <div class="layui-form-item">-->
...
<!--        <div class="layui-input-inline">-->
<!--            <button type="button" class="layui-btn layui-btn-normal" id="fellow_user_id">选择同行人</button>-->
...
<script>
    ...
    layui.use(['jquery', 'laydate','element','upload','form'], function() {
        ...
        //计算两个时间差
        function getTimeLong1(value1,value2) {
            var timeLong;
            var date3 = new Date(value2).getTime() - new Date(value1).getTime();   //时间差的毫秒数
            //计算出相差天数
            var days=Math.floor(date3/(24*3600*1000));
