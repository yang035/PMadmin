    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block fl" style="margin-left: 0px">
            <div class="layui-input-inline fl" style="width: 100px;">
                <input type="number" class="layui-input field-amount" name="amount[]" onblur="amout_sum()" autocomplete="off" lay-verify="required" placeholder="金额">
            </div>
            <div class="layui-form-mid">元</div>
            <div class="layui-input-inline" style="width: 300px;">
                <input type="text" class="layui-input field-mark" name="mark[]" autocomplete="off" lay-verify="required" placeholder="说明">
            </div>
        </div>
        <div class="fl new_task">
            <a href="javascript:void(0);" class="aicon ai-tianjia field-detail-add" style="float: left;font-size: 30px;"></a>
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    ...
    layui.use(['jquery', 'laydate','upload'], function() {
        ...
        $(".field-detail-add").click(function(){
            $(".field-detail-add").before("<div class=\"layui-input-block fl\"><div class=\"layui-input-inline\" style=\"width: 100px;\">\n" +
                "            <input type=\"number\" class=\"layui-input field-amount\" name=\"amount[]\" onblur=\"amout_sum()\" autocomplete=\"off\" lay-verify=\"required\" placeholder=\"金额\">\n" +
                "        </div>\n" +
                "        <div class=\"layui-form-mid\">元</div>\n" +
                "        <div class=\"layui-input-inline\" style=\"width: 300px;\">\n" +
