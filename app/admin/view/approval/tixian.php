...
<!--    </div>-->
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <textarea type="text" class="layui-textarea field-reason" name="reason" autocomplete="off" placeholder="备注说明" lay-verify="required"></textarea>
        </div>
        <div class="layui-form-mid" style="color: red">*</div>
    </div>
    <div class="layui-form-item">
...
<!--            <button type="button" class="layui-btn" id="send_user_id">选择汇报人</button>-->
            <div style="margin-top: 10px" id="send_select_id">{$chain_user['manager_user_id']}</div>
