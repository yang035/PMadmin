        ...
        <div class="row">
            ...
            <div class="col-md-2 col-sm-12 col-xs-12">
                <div class="top-nav"> <span class="top-text hidden-xs">
                        ...
                        <a target="_blank" href="{:url('Publics/index')}">登录</a>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="#">注册</a>
                        {else/}
            ...
            <div class="col-md-9 col-sm-12 col-xs-12">
                <div id="navigation">
                    ...
                    <ul>
                        ...
                        <li><a href="{:url('Publics/index')}" class="animsition-link">学习区</a></li>
                        <li><a href="{:url('Publics/index')}" target="_blank">工作区</a></li>
