...
<form class="layui-form layui-form-pane" action="{:url()}" method="post" id="editForm">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 100px">
            <input type="number" class="layui-input field-score" name="score[0]" autocomplete="off" placeholder="ML" onblur="checkScore(0,this.value)">
        </div>
        <div class="layui-input-inline" style="width: 100px">
...
layui.use(['jquery', 'laydate','upload','form','element'], function() {
    ...
    $(".new_task").click(function(){
        ...
        $(".new_task").before("<div class=\"layui-form-item\">\n" +
            ...
            "        </div>\n" +
            "        <div class=\"layui-input-inline\" style=\"width: 100px\">\n" +
            "            <input type=\"number\" class=\"layui-input field-score\" name=\"score["+len+"]\" autocomplete=\"off\" placeholder=\"ML\" onblur=\"checkScore("+len+",this.value)\">\n" +
            "        </div>\n" +
            "        <div class=\"layui-input-inline\" style=\"width: 100px\">\n" +
