...
<form class="page-list-form">
    ...
    <dl class="menu-dl1">
        <dt>
            ...
            <div class="menu-btns">
                <a href="{:url('edit?id='.$vv['id'].'&mod='.$vv['module'])}" title="编辑"><i class="layui-icon">&#xe642;</i></a>
        ...
        <dd>
            ...
            <dl class="menu-dl2">
                <dt>
                    ...
                    <div class="menu-btns">
                        <a href="{:url('edit?id='.$vvv['id'].'&mod='.$vvv['module'])}" title="编辑"><i class="layui-icon">&#xe642;</i></a>
                ...
                <dd>
                    ...
                    <div class="menu-btns">
                        <a href="{:url('edit?id='.$vvvv['id'].'&mod='.$vvvv['module'])}" title="编辑"><i class="layui-icon">&#xe642;</i></a>
    ...
    <form class="page-list-form">
        ...
        <dl class="menu-dl1">
            <dt>
                ...
                <div class="menu-btns">
                    <a href="{:url('edit?id='.$v['id'].'&mod='.$v['module'])}" title="编辑"><i class="layui-icon">&#xe642;</i></a>
                    <a href="{:url('add?pid='.$v['id'].'&mod='.$v['module'])}" title="添加子菜单"><i class="layui-icon">&#xe654;</i></a>
