...
<form class="layui-form" action="{:url()}" method="post">
    <div class="layui-tab-item layui-show layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <button type="button" class="layui-btn layui-btn-normal" id="manager_user_id">选择存储人</button>(由谁管理)
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <button type="button" class="layui-btn layui-btn-normal" id="deal_user_id">选择使用人</button>(由谁使用)
