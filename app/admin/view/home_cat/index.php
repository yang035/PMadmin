    ...
    <table class="layui-table mt10" lay-even="" lay-skin="row">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><input type="checkbox" name="status" {if condition="$vo['status'] eq 1"}checked=""{/if} value="{$vo['status']}" lay-skin="switch" lay-filter="switchStatus" lay-text="正常|关闭" data-href="{:url('status?table=home_cat&ids='.$vo['id'])}"></td>
                ...
                <td>
                    <div class="layui-btn-group">
                        ...
                        <a data-href="{:url('del?table=home_cat&ids='.$vo['id'])}" class="layui-btn layui-btn-primary layui-btn-sm j-tr-del"><i class="layui-icon">&#xe640;</i></a>
                        </div>
                    </div>
                </td>
            </tr>
