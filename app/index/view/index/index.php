            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="gtco-heading">
                        ...
                        <p>在未来中我们憧憬着美好生活，理想在奋斗中一步步的实现，越来越近，知道有一天我们的学习、工作、娱乐都会变成一种美好的生活！未来已来！设计良友相聚，共同期待！</p>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="feature-left">
                                ...
                                <div class="feature-copy">
                                    <h3>良友的精创空间</h3>
                                    <p>精品创意已不再是遥不可及的梦想或希望早些一切皆有可能</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="feature-left">
                                ...
                                <div class="feature-copy">
                                    <h3>良友成就美好</h3>
                                    <p>不在不敢回更加勇敢，不在不能回更加不凡，美好的瞬间变得更加简单</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
        ...
        <div class="gtco-container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2 text-center gtco-heading">
                    <h2>设计良友一起，工作更快乐</h2>
                    <p>伟大的思想和创意需要在有灵感的设计圈层碰撞和摩擦产生火花变成风景！因为有你风景才变得更加美丽！</p>
                </div>
            </div>
            <div class="row">
...
<div id="gtco-blog" data-section="blog">
    <div class="gtco-container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center gtco-heading">
                <h2>和良友在一起奋斗更快乐</h2>
                <p>轻松前行的背后，有你我的良友，为我夯实了再一次前行的信心，也是因为有你，我们勇气倍增，一步不停</p>
            </div>
        </div>
        <div class="row">
    ...
    <div id="gtco-counter" class="gtco-section">
        <div class="gtco-container">
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2 text-center gtco-heading">
                    <h2>和良友一起享受卓越更快乐</h2>
                    <p>就这样！简单告诉了你我，简单的描述了生活，简单的不再忧虑！就这样！设计良友专属圈层！</p>
                </div>
            </div>
    ...
    <div id="gtco-products" data-section="products">
        <div class="gtco-container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2 text-center gtco-heading">
                    <h2>和良友一起娱乐更快乐</h2>
                    <p>在良友圈层，每一个都是娱乐沸点的引爆者！更多的娱乐空间、时间和花样，总有一款适合你！圈层有边界，娱乐无极限，一起嗨起来！</p>
                </div>
            </div>
            <div class="row">
